      ...
      <div>
        ...
        <div id='mist' className='container'>
                ...
                <p id='intro'>
                      ...
                      CHOICE. <br/>
                        REFRESH THE PAGE TO RESET TO THE DEFAULT VIEW ON USING THE SELECTOR
                      FOR FILES AND THE WEBCAM </p>
              <br/>
              <button className='btn-secondary' id='starter' onClick={this.starter.bind(this)}> Click to start </button>
              <br/>
                ...
                <option value="watch">MY TIME</option>
                    ...
                    <div className="form-input">
                        ...
                        <label id="labe">ITEM:</label>
                             <input type='text' id="inp" className='col-lg-5  form-item'/> <br/>
                        </div>
