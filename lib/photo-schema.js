...
module.exports.Updatephoto = function (username, imagepath, cb) {
    photoapi.findOne({
        ...
        if (err || ismatch == null) {
            ...
            IsLinux === true ?
                mypath = `.\client\build\images\ ${ismatch.photoPath.replace(/\s/g,'')}`: mypath = `./client/build/images${ismatch.photoPath.replace(/\s/g,'')}`
...
module.exports.Deletephoto = function (username, cb) {
    ...
    photoapi.Findphoto(username, function (err, photo) {
        if (photo !== null) {
            ...
            IsLinux === true ? imagepath= `.\client\build\images\ ${photo.photoPath.replace(/\s/g,'')}`.replace(/\s/g,'') :
                imagepath = `./client/build/images/${photo.photoPath.replace(/\s/g,'')}`
